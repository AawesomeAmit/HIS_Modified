            ...
            if (getIntent().getStringExtra("type") != null) {
                if (getIntent().getStringExtra("type").equals("BP")) {
                    if (SharedPrefManager.getInstance(mActivity).getBpMachine() == 0) {
                        ...
                        startActivity(new Intent(mActivity, com.trueform.era.his.Activity.BP.BLE.DeviceControlActivity.class).putExtra("DEVICE_NAME", name).putExtra("DEVICE_ADDRESS", macAddress));
                    }
                } else {
