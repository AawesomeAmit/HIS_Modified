...
public class PatientNote extends BaseActivity implements View.OnClickListener {
        ...
        call.enqueue(new Callback<ViewProgressResp>() {
            ...
            public void onResponse(Call<ViewProgressResp> call, Response<ViewProgressResp> response) {
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        recyclerView.setAdapter(new PatientNoteAdp(context, response.body().getProgressList()));
                    }
                }
                Utils.hideDialog();
            }
    ...
    public class PatientNoteAdp extends RecyclerView.Adapter<PatientNoteAdp.RecyclerViewHolder> {
        private Context mCtx;
        private List<ProgressList> progressList;

        public PatientNoteAdp(Context mCtx, List<ProgressList> progressList) {
            this.mCtx = mCtx;
        ...
        @NonNull
        @Override
        public PatientNoteAdp.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            return new PatientNoteAdp.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull PatientNoteAdp.RecyclerViewHolder holder, int i) {
