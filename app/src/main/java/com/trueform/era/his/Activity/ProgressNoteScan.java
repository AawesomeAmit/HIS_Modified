...
public class ProgressNoteScan extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_progress_note_scan);
    ...
    private void getConsultantName(){
        ...
        Call<ControlBySubDeptResp> call = RetrofitClient.getInstance().getApi().getControlsBySubDept(SharedPrefManager.getInstance(this).getUser().getAccessToken(), SharedPrefManager.getInstance(mActivity).getUser().getUserid().toString(), SharedPrefManager.getInstance(this).getSubdeptID(), SharedPrefManager.getInstance(this).getHeadID(), SharedPrefManager.getInstance(this).getUser().getUserid());
    ...
    private void getVitals() {
        Call<VitalListResp> call = RetrofitClient.getInstance().getApi().getPatientVitalList(
                ...
                SharedPrefManager.getInstance(context).getSubdeptID(),
    ...
    private void saveProgressReport(int drId) {
        ...
        try {
            ...
            jsonObject.put("subDeptID", SharedPrefManager.getInstance(context).getSubdeptID());
    ...
    private void hitGetProgressHistory(String date){
        ...
        Call<ViewProgressResp> call= RetrofitClient.getInstance().getApi().getProgressHistory(
                ...
                SharedPrefManager.getInstance(mActivity).getSubdeptID(),
                SharedPrefManager.getInstance(mActivity).getUser().getUserid(),
                date,
                60
        );
    ...
    public class ProgressHistoryAdapter extends RecyclerView.Adapter<ProgressHistoryAdapter.RecyclerViewHolder> {
        ...
        public ProgressHistoryAdapter.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            return new ProgressHistoryAdapter.RecyclerViewHolder(view);
        }
