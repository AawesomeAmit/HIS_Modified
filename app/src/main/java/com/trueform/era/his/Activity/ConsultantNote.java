...
public class ConsultantNote extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultant_note);
        ...
        call.enqueue(new Callback<ViewProgressResp>() {
            ...
            public void onResponse(Call<ViewProgressResp> call, Response<ViewProgressResp> response) {
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        recyclerView.setAdapter(new ConsultantNoteAdp(context, response.body().getProgressList()));
                    }
                }
                Utils.hideDialog();
            }
    ...
    public class ConsultantNoteAdp extends RecyclerView.Adapter<ConsultantNoteAdp.RecyclerViewHolder> {
        private Context mCtx;
        private List<ProgressList> progressList;

        public ConsultantNoteAdp(Context mCtx, List<ProgressList> progressList) {
            this.mCtx = mCtx;
