...
public class OTNote extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_o_t_note);
        ...
        call.enqueue(new Callback<ViewProgressResp>() {
            ...
            public void onResponse(Call<ViewProgressResp> call, Response<ViewProgressResp> response) {
                if (response.body() != null) {
                    if (response.isSuccessful()) {
                        recyclerView.setAdapter(new OTNoteAdp(context, response.body().getProgressList()));
                    }
                }
                Utils.hideDialog();
            }
    ...
    public class OTNoteAdp extends RecyclerView.Adapter<OTNoteAdp.RecyclerViewHolder> {
        private Context mCtx;
        private List<ProgressList> progressList;

        public OTNoteAdp(Context mCtx, List<ProgressList> progressList) {
            this.mCtx = mCtx;
        ...
        @NonNull
        @Override
        public OTNoteAdp.RecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
            ...
            return new OTNoteAdp.RecyclerViewHolder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull OTNoteAdp.RecyclerViewHolder holder, int i) {
