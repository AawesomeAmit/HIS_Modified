...
public class PatientHistoryActivity extends BaseActivity implements View.OnClickListener {
    ...
    public class ProgressHistoryAdapter extends RecyclerView.Adapter<ProgressHistoryAdapter.RecyclerViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ProgressHistoryAdapter.RecyclerViewHolder holder, int i) {
            ...
            holder.ivEdit.setOnClickListener(view -> {
                ...
                SpannableString text = new SpannableString(Html.fromHtml(progressList.get(i).getDetails().trim()));

                //edtProgress.setText(text);

                richTextEditor.setHtml(progressList.get(i).getDetails().trim());

               /* if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    edtProgress.setText(Html.fromHtml(holder.tvProgressNote.getText().toString().trim(), Html.FROM_HTML_MODE_COMPACT));
                } else {
                    edtProgress.setText(Html.fromHtml(holder.tvProgressNote.getText().toString().trim()));
                }*/
